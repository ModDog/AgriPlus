package agriplus.mod.items.seeds;
...
public class ItemBarleySeed extends Item implements IHasModel, IPlantable
{
	public ItemBarleySeed(String name)
	{
			...
			EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		{
			worldIn.setBlockState(pos.up(), BlockInit.BarleyCrop.getDefaultState());
			stack.shrink(1);
	...
	{
		return BlockInit.BarleyCrop.getDefaultState();
	}
}
